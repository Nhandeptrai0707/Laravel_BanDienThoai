 ...
 <body class="bg-gray-100">
  ...
  <header class="bg-yellow-500 p-4 flex items-center justify-between">
    <div class="flex items-center">
        <img alt="Logo" class="mr-2 btn-maloai" height="50" src="https://storage.googleapis.com/a1aa/image/1-JtT3asIGzXAC0AZ9zd961SBV4N_eH2KTO4eiUJleY.jpg" width="50" data-maloai=""/>
    ...
    <div class="flex items-center space-x-4 w-full">
     ...
     <button class="text-black hover:bg-white hover:rounded-lg transition duration-300 p-2"> <i class="fas fa-user">
        </i> {{ $khach->TenKH ?? 'Khách hàng' }}
     </button>   
     <button class="text-black hover:bg-white hover:rounded-lg transition duration-300 p-2">
...
`                           );
        ...
        $(window).scroll(function () {
            ...
            if (scrollTop + windowHeight >= docHeight && action == 'inactive') {
                action = 'active';
                start += limit;
                setTimeout(function () {
                    loadData(limit, start, maloai);
